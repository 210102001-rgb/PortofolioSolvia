<div class="inv-buttons" style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px;">
  <div>
    <h2 style="color:#fff; font-weight:700; font-size:18px;">Invoice</h2>
    <p style="color:#94a3b8; font-size:14px;"><?= e($inv['invoice_number']) ?></p>
  </div>
  <div style="display:flex; gap:12px;">
    <a href="<?= url('/sso/invoice') ?>" style="padding:10px 20px; background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.1); color:#94a3b8; border-radius:12px; font-size:14px; font-weight:500; text-decoration:none; transition:all 0.2s;">
      Kembali
    </a>
    <a href="<?= url('/sso/invoice/' . $inv['id'] . '/edit') ?>" style="padding:10px 20px; background:rgba(139,92,246,0.2); border:1px solid rgba(139,92,246,0.3); color:#a78bfa; border-radius:12px; font-size:14px; font-weight:500; text-decoration:none; transition:all 0.2s;">
      Edit
    </a>
    <a href="<?= url('/sso/invoice/' . $inv['id'] . '/print?auto=1') ?>" target="_blank" style="padding:10px 20px; background:#2563eb; border:none; color:#fff; border-radius:12px; font-size:14px; font-weight:600; cursor:pointer; display:inline-flex; align-items:center; gap:8px; box-shadow:0 4px 16px rgba(37,99,235,0.3); text-decoration:none;">
...
<style>
  @media print {
    ...
    main > .flex.items-center { display: none !important; }
    #invoice-area { page-break-inside: avoid; border-radius: 0 !important; box-shadow: none !important; }
    #invoice-area > div:first-child { border-radius: 0 !important; box-shadow: none !important; }
    #invoice-area .inv-buttons { display: none !important; }
  ...
  .inv-table { width: 100%; border-collapse: collapse; }
    .inv-table th {
      background-color: #0a2463; color: #ffffff;
      font-weight: 600; font-size: 12px; text-transform: uppercase;
      letter-spacing: 0.05em; padding: 10px 14px; text-align: left;
    }
    .inv-table td {
      padding: 10px 14px; border-bottom: 1px solid #e5e7eb;
      font-size: 13px; vertical-align: top; color: #1f2937;
    }
    .inv-table tr:last-child td { border-bottom: none; }
    @media print {
      .inv-table th { background-color: #0a2463 !important; color: white !important; }
    }
  </style>
